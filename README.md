...
![validate](https://github.com/menzenski/tap-mongodb/actions/workflows/validate.yaml/badge.svg)
...
```bash
pipx install git+https://github.com/menzenski/tap-mongodb.git@main
```
